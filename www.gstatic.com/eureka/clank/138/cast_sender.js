(function() {
    ...
    */
    ...
    chrome.cast.qc = !0;
    x("chrome.cast.usingPresentationApi", chrome.cast.qc);
    ...
    */
    ...
    f.sendMessage = function(a, b, c, d) {
        B.jc(new Ha(this.sessionId, a, b), c, d)
    };
    f.X = function(a) {
        B.Hb(this.sessionId, a)
    };
    f.aa = function(a) {
        B.hc(this.sessionId, a)
    };
    f.Gb = function(a, b) {
        B.Eb(this.sessionId, a, b)
    };
    f.V = function(a) {
    ...
    chrome.cast.j.prototype.setReceiverMuted = chrome.cast.j.prototype.mc;
    chrome.cast.j.prototype.setReceiverVolumeLevel = chrome.cast.j.prototype.nc;
    var D = function(a, b) {
    ...
    x("chrome.cast.setCustomReceivers", chrome.cast.kc);
    chrome.cast.lc = function(a, b) {
        b()
    };
    x("chrome.cast.setReceiverDisplayStatus", chrome.cast.lc);
